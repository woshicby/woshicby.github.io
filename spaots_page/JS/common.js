...
var PAGE_TYPE = (function() {
  ...
  if (path.indexOf('summary-active') !== -1) return 'active';
  if (path.indexOf('summary-volume') !== -1) return 'volume';
  if (path.indexOf('activity') !== -1 && path.indexOf('summary-active') === -1) return 'activity';
  return 'home';
})();
...
function getThemeColors() {
  ...
  return {
    bg: style.getPropertyValue('--color-bg').trim() || '#171717',
    brand: style.getPropertyValue('--color-brand').trim() || '#e0ed5e',
    track: style.getPropertyValue('--svg-color-active-cell').trim() || '#4dd2ff',
    special: style.getPropertyValue('--svg-special-color').trim() || '#f7d02c',
    special2: style.getPropertyValue('--svg-special-color2').trim() || '#f56c6c',
    text: style.getPropertyValue('--color-brand').trim() || '#e0ed5e',
    chartText: style.getPropertyValue('--color-run-date').trim() || '#d4d4d4',
    dim: style.getPropertyValue('--color-dim').trim() || '#555555',
    empty: style.getPropertyValue('--color-empty').trim() || '#333333',
    onBrand: style.getPropertyValue('--color-on-brand').trim() || '#000000',
  };
}
